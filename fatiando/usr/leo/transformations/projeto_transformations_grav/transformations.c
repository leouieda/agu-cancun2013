...
void leitura_parametros (FILE *relatorio, int *M, char arquivo_camada[DIMENSAO_STRING], int *continuacao_interpolacao, char arquivo_continuacao_interpolacao[DIMENSAO_STRING], int *tensor, char arquivo_tensor[DIMENSAO_STRING]);
...
void main () {
	...
	*/
	...
	leitura_parametros(relatorio, &M, &Z_layer, arquivo_camada, &continuacao_interpolacao, arquivo_continuacao_interpolacao, &tensor, arquivo_tensor);
	...
	if ((continuacao_interpolacao != 0) && ((continuacao_interpolacao == 1) || (continuacao_interpolacao == 2))) {
		...
		saida = fopen("gz_calculado.txt", "w");
...
void leitura_parametros (FILE *relatorio, int *M, double *Z_layer, char arquivo_camada[DIMENSAO_STRING], int *continuacao_interpolacao, char arquivo_continuacao_interpolacao[DIMENSAO_STRING], int *tensor, char arquivo_tensor[DIMENSAO_STRING]) {
	...
	if (fscanf (entrada, "%d %lf %s %d %s %d %s", M, Z_layer, arquivo_camada, continuacao_interpolacao, arquivo_continuacao_interpolacao, tensor, arquivo_tensor) != 7) {
